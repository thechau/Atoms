...
public struct SlideMenuOptions {
    public static var leftViewWidth: CGFloat = UIScreen.main.bounds.width - 50
    ...
    public static var rightViewWidth: CGFloat = UIScreen.main.bounds.width - 50
...
open class SlideMenuController: UIViewController, UIGestureRecognizerDelegate {
    ...
    open func initView() {
      ...
      if rightViewController != nil {
        ...
        rightFrame.size.width = UIScreen.main.bounds.width - 50//SlideMenuOptions.rightViewWidth
