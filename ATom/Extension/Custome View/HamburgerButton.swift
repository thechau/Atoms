...
class HamburgerButton : UIButton {
    ...
    override init(frame: CGRect) {
        ...
        self.top.position = CGPoint(x: 40, y: 4)

        self.middle.position = CGPoint(x: 27, y: 11)
...
//                strokeStart.timingFunction = CAMediaTimingFunction(controlPoints: 0.1, -0.4, 0.5, 1)
//
//                strokeEnd.toValue = menuStrokeEnd
//                strokeEnd.duration = 0.6
//                strokeEnd.timingFunction = CAMediaTimingFunction(controlPoints: 0.1, -0.4, 0.5, 1)
//            } else {
