...
fileprivate extension ACFloatingTextfield {
    ...
    func addFloatingLabel(){
        ...
        labelPlaceholder?.font = UIFont(name: "Roboto-Regular", size: 15)!
        labelPlaceholder?.isHidden = true
        labelPlaceholder?.sizeToFit()
        labelPlaceholder?.translatesAutoresizingMaskIntoConstraints = false
//        let placeholderString = NSAttributedString.init(string:"", attributes: [NSAttributedString.Key.foregroundColor :  self.selectedPlaceHolderColor])
...
//            self.setValue(placeHolderColor, forKeyPath: "_placeholderLabel.textColor")
        ...
        labelPlaceholder?.font = UIFont(name: "Roboto-Light", size: 9)!
