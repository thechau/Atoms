...
//  ATom
//
//  Created by phan.the.chau on 2/26/20.
...
class DeviceCollectionViewCell: UICollectionViewCell {
    ...
    func animation3() {
        ...
        topConstraintCollectionView.constant = self.contentView.frame.height / 2 + 50
        //Test
...
extension DeviceCollectionViewCell: UICollectionViewDelegateFlowLayout{
...
extension DeviceCollectionViewCell: UICollectionViewDataSource{
...
extension DeviceCollectionViewCell: DashBoardCollectionViewCellDelegate {
    func connect() {
...
extension DeviceCollectionViewCell: FailedToconnectDeviceViewDelegate {
    func retryButton() {
...
extension DeviceCollectionViewCell: DashBoardElectrodesCollectionViewCellDelegate {
